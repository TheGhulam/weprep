...
def get_technical_prompt(num_ques, interview_topic):
    return """imagine you are the best technical interviewer in the world who only answers using JSON objects.  you need to come up with the best {num_ques} technical interview questions tailored to your candidate for a certain job description.
    Question batch criteria:  avoid generic questions. The questions should be specific to the job description which is {interview_topic} and the resume provided. each question should relate to some part of the job description and if possible, some part of the candidate's resume. avoid explicitly mentioning the “job description” in your questions because you need to sound exactly like a professional technical recruiter. make sure it's technical interview questions. Each of the 5 questions you will be asking should follow this standard in the same order:
    ...
    {"questions":[{"id":1,"text":"What is your favorite color?","follow_ups":[{"id":101,"text":"Why do you like that color?","follow_ups":[]},{"id":102,"text":"Do you have any childhood memories associated with that color?","follow_ups":[]}]},{"id":2,"text":"What is your favorite food?","follow_ups":[{"id":201,"text":"How did you discover that food?","follow_ups":[]},{"id":202,"text":"Have you ever tried cooking that food yourself?","follow_ups":[]}]}]}
     ...
     You can add a minimum of 1 and a maximum of 2 follow-up questions. The follow-up questions should relate to their parent question batch in terms of content and standard. In a natural setting, the follow-up questions should go into more detail, ask about fine-grained details, and ask for thought process demonstrations using specific examples and scenarios.
    """.format(
        num_ques=num_ques, interview_topic=interview_topic
    )  # noqa
